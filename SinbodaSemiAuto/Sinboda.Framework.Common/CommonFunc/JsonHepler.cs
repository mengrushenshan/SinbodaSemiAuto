...
namespace Sinboda.Framework.Common.CommonFunc
{
    public class JsonHepler
    {
        ...
        public static string ToJson(DeviceOptionsModel model)
        {
            StringBuilder jsonString = new StringBuilder();
            jsonString.Append("{");
            jsonString.Append("\"productKey\":");
            string keyValue = StringFormat(model.productKey, typeof(string));
            jsonString.Append(keyValue + ",");
            jsonString.Append("\"deviceName\":");
            string typeValue = StringFormat(model.deviceName, typeof(string));
            jsonString.Append(typeValue + ",");
            jsonString.Append("\"clientId\":");
            string idValue = StringFormat(model.clientId, typeof(string));
            jsonString.Append(idValue);
            jsonString.Append("}");
            if (jsonString.Length == 1)
            {
                return "{}";
    ...
    public class DynamicJson : DynamicObject
    {
        ...
        #region dynamic structure represents JavaScript Object/Array
