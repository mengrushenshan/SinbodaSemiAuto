        ...
        public static void DecryptFile(string inFile, string outFile, string password)
        {
                ...
                fout = File.OpenWrite(outFile))
            {
                    ...
                    chash = new CryptoStream(Stream.Null, hasher, CryptoStreamMode.Write))
                {
                    ...
                    if (FC_TAG != tag)
                        throw new CryptoHelpException(StringResourceExtension.GetLanguage(20, "文件被破坏"));//TODO翻译
                ...
                if (outValue != lSize)
                    throw new CryptoHelpException(StringResourceExtension.GetLanguage(19, "文件大小不匹配"));//TODO翻译
            }
        }
    }
}
